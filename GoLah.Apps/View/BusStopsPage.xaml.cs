...
namespace GoLah.Apps.View
{
    ...
    /// </summary>
    public sealed partial class BusStopsPage : Page
    {
        ...
        private void lvBusStops_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            UpdateMap();
        }
        ...
        private async void UpdateMap()
        {
            ...
            var busStop = lvBusStops.SelectedItem as BusStop;
